      ...
      {location === "/" && <header className="aviation-hero relative overflow-hidden px-6 pb-7 pt-6 lg:px-10">
        ...
        <div className="relative mx-auto max-w-[1500px]">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3"><div className="logo-mark"><Plane size={22} /></div><div><div className="text-xl font-bold tracking-tight text-white">Imcan</div><div className="text-[10px] font-semibold uppercase tracking-[0.28em] text-[#38bdf8]">Team</div></div></div>
