...
export default function Home() {
  ...
  return <DashboardLayout>
    <div className="min-h-screen bg-[#020813] text-[#e2e8f0]">
      {location === "/" && <header className="aviation-hero relative overflow-hidden px-6 pb-7 pt-6 lg:px-10">
        ...
        <div className="relative mx-auto max-w-[1500px]">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3"><div className="logo-mark"><Plane size={22} /></div><div><div className="text-xl font-bold tracking-tight text-white">Flight Deck</div><div className="text-[10px] font-semibold uppercase tracking-[0.28em] text-[#38bdf8]">Imkan Data Aviation</div></div></div>
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-[1fr_390px] lg:items-end"><div><div className="mb-3 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#38bdf8]"><span className="h-px w-8 bg-[#38bdf8]" /> Command & Control</div><h1 className="max-w-3xl text-4xl font-bold leading-[1.05] tracking-[-0.04em] text-white lg:text-6xl">Data navigation,<br /><span className="text-[#38bdf8]">At Mach Speed.</span></h1><p className="mt-5 max-w-xl text-sm leading-6 text-slate-300">Interact with millions of files simultaneously. Our multi-layer architecture delivers zero-latency answers, precisely calculated like an aircraft's flight path.</p></div><div className="hero-route hidden lg:block"><div className="route-line" /><div className="route-plane"><Plane size={17} /></div><span className="route-label route-a">DEPARTURE</span><span className="route-label route-b">DESTINATION</span></div></div>
        </div>
      </header>}
